namespace VPetLLM.Core.Integration.UnifiedTTS.Management
{
    ...
    /// 处理 TTS 类型选择和基本配置管理
    /// </summary>
    public class ConfigurationManager : UnifiedTTSConfigManager
    {
        ...
        /// 配置变更事件
        /// </summary>
        public event EventHandler<UnifiedTTSConfigChangedEventArgs> ConfigurationChanged;
        ...
        private void OnConfigurationChanged(TTSConfiguration oldConfig, TTSConfiguration newConfig, string reason)
        {
            try
            {
                var args = new UnifiedTTSConfigChangedEventArgs(oldConfig, newConfig, reason);
