    ...
    public class RecordManager
    {
        ...
        public int CreateRecord(string content, int weight)
        {
            try
            {
                ...
                if (recordId > 0)
                {
                    ...
                    if (_settings.Records is not null && _settings.Records.MaxRecordsLimit > 0)
                    {
        ...
        public void OnConversationTurn()
        {
            try
            {
                ...
                if (_settings.Records is null || !_settings.Records.AutoDecrementWeights)
                {
                    return;
                }
        ...
        public string GetRecordsContext()
        {
            try
            {
                ...
                if (_settings.Records is not null && _settings.Records.MaxRecordsInContext > 0)
                {
        ...
        public List<Message> InjectRecordsIntoHistory(List<Message> history)
        {
            try
            {
                ...
                if (_settings.Records is null || !_settings.Records.EnableRecords)
                {
                    return history;
                }
